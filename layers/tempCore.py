...
class ConvolutionalLayer(object):
    def __init__(self, shape, output_channels, ksize=3, stride=1, tipe_operasi = 'training', nama="none", folder="1"):
    ...
    def simpan(self):
        nama_file = 'temp/manual/'+ self.folder +''+ self.nama +'_lr0,001.npy'
        nama_file_bias = 'temp/manual/'+ self.folder +''+ self.nama +'_bias_lr0,001.npy'
...
class FullyConnectedLayer(object):
    def __init__(self, shape, output_num=2, tipe_operasi = 'training', nama="none", folder="1"):
        self.input_shape = shape
        self.nama = nama
